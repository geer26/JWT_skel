...
class Config(object):
    ...
    SESSION_COOKIE_NAME = os.environ.get('SESSION_COOKIE_NAME') or '!CHANGE_THIS!'
    COOKIE_LIFESPAN = os.environ.get('SESSION_LIFESPAN') or 60 * 60 * 24 * 30 #30 days by default
    ENV_FOLDER = basedir
    #LOGIN_EXP_TIME = 3600
